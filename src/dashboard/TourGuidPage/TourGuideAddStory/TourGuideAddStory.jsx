...
const TourGuideAddStory = () => {
    ...
    const handleAddStory = async (data) => {
        ...
        try {
            ...
            // upload in database
            const res = await axiosSecure.post(`/stories/tour-guide-story?email=${user.email}`, newStory);

            if(res.data.acknowledged){
                successAlert("Your story has been uploaded.");
                navigate("/dashboard/tour-guide-manage-stories");
                reset();
            }
        } catch (error) {
...
export default TourGuideAddStory;