                ...
                <div className="flex flex-col justify-center px-5 mt-5 md:mt-0">
                    ...
                    <div className="max-w-5xl pt-5">
                        <form onSubmit={handleSubmit(handleRegister)} className="space-y-3 text-center">
                            ...
                            <p className="text-left text-red-600">{errors.file?.message}</p>
                            ...
                            <button type="submit" className="w-32 h-12 rounded-full text-lg font-semibold text-white bg-teal active:scale-95 duration-100 ease-in-out transition-all">Register</button>
                        </form>
                    </div>
